...
class ResultadosTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ESTADOSRESULTADOS_ID', 'EstadosresultadosId', 'INTEGER', 'estadosresultados', 'ID', false, 11, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('Estadosresultados', 'Estadosresultados', RelationMap::MANY_TO_ONE, array('estadosresultados_id' => 'id', ), 'RESTRICT', 'RESTRICT');
