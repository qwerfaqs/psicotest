...
class PreguntasTableMap extends TableMap {
    ...
    $this->addRelation('Respuestas', 'Respuestas', RelationMap::ONE_TO_MANY, array('id' => 'preguntas_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Resultadosparciales', 'Resultadosparciales', RelationMap::ONE_TO_MANY, array('id' => 'preguntas_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
