...
class AspirantesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('NOMBRE', 'Nombre', 'VARCHAR', false, 60, null);
		$this->addColumn('APELLIDO', 'Apellido', 'VARCHAR', false, 60, null);
		$this->addColumn('CEDULA', 'Cedula', 'CHAR', false, 30, null);
		$this->addColumn('PASSWORD', 'Password', 'CHAR', false, 20, null);
		// validators
	} // initialize()
