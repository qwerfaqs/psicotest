...
class RespuestasTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TEXTO', 'Texto', 'CHAR', false, 100, null);
		$this->addForeignKey('RESPUESTAS_ID', 'RespuestasId', 'INTEGER', 'preguntas', 'ID', true, 11, null);
	...
	{
    $this->addRelation('Preguntas', 'Preguntas', RelationMap::MANY_TO_ONE, array('respuestas_id' => 'id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Valoresdeverdad', 'Valoresdeverdad', RelationMap::MANY_TO_ONE, array('estados_id' => 'id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Resultadosparciales', 'Resultadosparciales', RelationMap::ONE_TO_MANY, array('id' => 'respuestas_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
