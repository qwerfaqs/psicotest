<table summary="Submitted table designs">
    ...
    <tr class="<?php echo fmod($i, 2) ? 'even' : 'odd' ?>">
      <td><?php echo $resultado->getId() ?></a></td>
        <th scope="row" ><a href="<?php echo url_for('pruebas/parciales').'?prueba='.$resultado->getPruebas()->getId().'&&id='.$resultado->getAspirantes()->getId().'&&resultado='.$resultado->getId() ?>"><?php echo $resultado->getAspirantes()->getCedula() ?></a></th>      
